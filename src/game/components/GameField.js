...
export const Field = memo(function Field ({
    ...
    const useGameField = (field, hiddenCells, updateLevel) => {
        const [gameField, setGameField] = useState(field)
        const [gameHiddenCells, setGameHiddenCells] = useState(hiddenCells)
        ...
        const onCellClick = ({ target }) => {
            ...
            if(hiddenCells.includes(id)) {
                ...
                setGameHiddenCells(updatedHidden)
            ...
            return setTimeout(updateLevel, 1000, TextTrackCue)
